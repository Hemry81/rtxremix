...
def initPath():
    ...
    global m_capture_directory, m_ignoreFilesfromFolder, m_modUSDA, m_output_file, m_ignoreListFiles, m_newtex_dirctory
    ...
    m_ignoreListFiles = f'{dirname}/{ignoreListFiles}'
    m_newtex_dirctory = f'{dirname}/{newtex_dirctory}'
...
def readConfig():
    global gamefolder, modfolder, m_capture_directory, m_ignoreListFiles, m_ignoreFilesfromFolder, m_modUSDA, m_output_file, m_newtex_dirctory
    try:
        ...
        for line in lines:
            if "gamefolder = " in line:
                ...
                m_ignoreListFiles = line.replace("ignoreListFiles = ", "").strip("\n").strip("\t").strip("\r")
                ...
                m_newtex_dirctory = line.replace("newtex_dirctory = ", "").strip("\n").strip("\t").strip("\r")
    except:
        print("===========================================================================================")
...
def main():
    ...
    save_button.grid(row=0, column=3, sticky="w", padx=5, pady=5)
